// ignore_for_file: prefer_const_constructors, use_key_in_widget_constructors, avoid_function_literals_in_foreach_calls, prefer_typing_uninitialized_variables
...
class DowloadTest extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform? platform;

  DowloadTest({Key? key, this.title, this.platform}) : super(key: key);

  final String? title;

  @override
  _DowloadTestState createState() => new _DowloadTestState();
}

class _DowloadTestState extends State<DowloadTest> {
  final _documents = [
    {
      'name': 'Test File',
      'link':
          'https://a36c-103-100-135-183.ngrok.io/api/ShowPdf/20220518004305039_044_050_Project Schedule Network Diagram.pdf'
    },
    {
  ...
  Future<Null> _prepare() async {
    ...
    _task = _TaskInfo(
        name: 'Test File',
        link: BASE_URL +
            '/api/ShowPdf/202205181934161911.09070.pdf');
