...
class BrowseActivityPageProvider extends ChangeNotifier {
  List<StatusMenu> _menus = [
    ...
    StatusMenu(id: "validated", statusName: "Validated", selected: false),
    StatusMenu(id: "hold", statusName: "Hold", selected: false),
    StatusMenu(id: "closed", statusName: "Closed", selected: false),
  ];
